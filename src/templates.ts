...
export const TEMPLATES: StoryTemplate[] = [
  {
    ...
    transitionKind: "pop",
    transitionSequence: ["pop", "zoom", "slide", "flip", "flash"],
    transitionLabel: "Pop · zoom · flip",
    effectKind: "punch",
  ...
  },
  {
    ...
    transitionSequence: ["dissolve", "zoom", "wipe"],
    transitionLabel: "Dissolve · drift · wipe",
  ...
  },
  {
    ...
    transition: "wipeleft",
    transitionKind: "wipe",
    transitionSequence: ["wipe", "pop", "flip", "zoom"],
    transitionLabel: "Wipe · pop · flip",
    effectKind: "bold",
  ...
  },
  {
    ...
    transitionSequence: ["flash", "spin", "zoom", "slide"],
    transitionLabel: "Flash · spin · zoom",
    effectKind: "film",
  ...
  },
  {
    ...
    transitionSequence: ["slide", "pop", "flip", "zoom", "wipe"],
    transitionLabel: "Slide · pop · flip",
  ...
  },
  {
    ...
    transitionSequence: ["clean", "dissolve", "zoom"],
    transitionLabel: "Fade · dissolve · zoom",
    effectKind: "subtle",
